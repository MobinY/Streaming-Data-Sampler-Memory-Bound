...
By \url{http://mathworld.wolfram.com/q-PochhammerSymbol.html} We have $\prod_{j=1}^{\infty} \frac{1}{1-2^{-j/K}}\le 2^{2K}$ ({\color{red} Need to give a more rigorous bound later}).

Combine together we get $\E(b_r)\ge 1-\frac{2K+1}{\log \frac{1}{\delta}}\ge \frac{1}{2}$. 
