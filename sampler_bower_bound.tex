...
%Not known... most likely false
%\begin{remark}
%  The space lower bound still applies if the sampler is required to output an arbitrary item whose coordinate is non-zero instead of a uniformly random one. 
%\end{remark}
