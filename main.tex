...
\begin{proof}
  ...
  \begin{align}
    \prod_{i=1}^{r}{\frac{{n_{i-1}-n_r-1 \choose n_{i-1}-n_i-1}}{{n_{i-1}-1 \choose n_{i-1}-n_i-1}}} \le \frac{2^{6K}}{{m \choose n_r}}. \label{formula:prod-bound}
  \end{align}
  ...
  \begin{align}
    ...
    \label{formula:bound-with-floor}
  \end{align}
  ...
  By Lemma~\ref{lemma:Pochhammer}, we have $\prod_{j=1}^{\infty} \frac{1}{1-2^{-j/K}}\le 2^{5K}$. Therefore, the right hand side of Formula~\ref{formula:bound-with-floor} is upper bounded by $2^{6K}$. Together with Formula~\ref{formula:telescoping}, we prove Formula~\ref{formula:prod-bound} holds.  
