...
\title{Optimal lower bounds for universal relation, samplers, and more}
...
We thank Vasileios Nakos for pointing out that our $\ur$ lower bound immediately implies a tight lower bound for finding a duplicate in data streams.
